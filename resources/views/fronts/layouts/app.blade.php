...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">--Get A Job--</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item">
						<a class="nav-link" aria-current="page" href="jobs.html">Explore Jobs</a>
					</li>										
				</ul>				
				<a class="btn btn-outline-primary me-2" href="login.html" type="submit">Login</a>
				<a class="btn btn-primary" href="post-job.html" type="submit">Hiring? Post a Job</a>
			</div>
		</div>
	</nav>
</header>
<section class="section-0 lazy d-flex bg-image-style dark align-items-center "   class="" data-bg="{{ asset('assets/images/corporate.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Find Dour Dream Job!</h1>
                <p>Jobs available in Bangladesh and beyond.</p>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 Tanvir Mahtab, all right reserved</p>
</div>
</footer> 
